...
function login(event) {
    ...
    h2.textContent = "Login Button Clicked";
    ...
    if(user === USER && pswd === PSWD) {
        h2.textContent = `Welcome, ${user}`; // output Welcome
...
//     be there
loginBtn.addEventListener('mouseover', setSessionVariables);
...
function setSessionVariables() {
    ...
    sessionStorage.setItem("pswd", password.value);
}
